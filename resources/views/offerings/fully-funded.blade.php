...
@section('title')
<title> Angele Investments | Fully Funded</title>
@endsection
    ...
    <section class="sort-projects-sec">
        <div class="container">
            <div class="sorting-filters position-relative" id="scroll-div">
                ...
                @if($filter)
                    <div class="">
                        <a href="{{ route('fully-funded') }}" class="clear-filter">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-4 col-sm-12 col-12">
                                <div class="project-card-main">
                                    <div class="project-thumb">
                                        ...
                                        <img src="{{ asset('offerings/banner') }}/{{!empty($offering->offering_bg) ? $offering->offering_bg : 'default-img.png'}}" alt=""
...
@section('scripts')
    <script>
        $('.project-filter').on('change', function () {
            ...
            let url = '{{ url('offerings/fully-funded').'/' }}' + filter_type + '/' + selected_val;
